        ...
        class BeautifyRenderPass : ScriptableRenderPass {
                ...
                if (beautify.directWrite.value) {
                    ...
                    if (beautify.debugOutput.value == Beautify.DebugOutput.DepthOfFieldCoC) {
                        ...
                        if (beautify.bloomIntensity.value > 0 && beautify.bloomExcludeLayers.value) {
                            // we ignore input contents
                            Blit(cmd, source, BuiltinRenderTextureType.CameraTarget, bMat, (int)Pass.BloomExclusionLayerDebug);
                        }
                        ...
                        if (beautify.depthOfField.value && beautify.depthOfFieldTransparentSupport.value) {
                            // we ignore input contents
                            Blit(cmd, source, BuiltinRenderTextureType.CameraTarget, bMat, (int)Pass.DoFDebugTransparent);
                        }
                    } else
                    ...
                    if (beautify.debugOutput.value == Beautify.DebugOutput.DepthOfFieldCoC) {
                        ...
                        if (beautify.bloomIntensity.value > 0 && beautify.bloomExcludeLayers.value) {
                            // we ignore input contents
                            Blit(cmd, ShaderParams.inputTex, source, bMat, (int)Pass.BloomExclusionLayerDebug);
                        }
                    } else if (beautify.debugOutput.value == Beautify.DebugOutput.DepthOfFieldTransparentPass) {
                        if (beautify.depthOfField.value && beautify.depthOfFieldTransparentSupport.value) {
                            // we ignore input contents
                            Blit(cmd, ShaderParams.inputTex, source, bMat, (int)Pass.DoFDebugTransparent);
                        }
                    } else
                    if (beautify.blurIntensity.value > 0) {
                        ApplyFinalBlur(cmd);
            ...
            void UpdateMaterialProperties() {
                ...
                if (beautify.depthOfField.value && (beautify.optimizeBuildBeautifyAuto.value || !beautify.stripBeautifyDoF.value)) {
                    ...
                    if (beautify.depthOfFieldTransparentSupport.value && beautify.depthOfFieldTransparentLayerMask.value > 0 && (beautify.optimizeBuildBeautifyAuto.value || !beautify.depthOfFieldTransparentSupport.value)) {
