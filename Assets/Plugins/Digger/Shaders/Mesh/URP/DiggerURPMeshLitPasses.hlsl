...
half4 SampleTriplanar(float3 positionWS, float4 normal, Texture2D tex, SamplerState samp, float2 tile, float2 offset) {
...
void SplatmapMix(float3 positionWS, float4 normal, inout half4 splatControl, out half weight, out half4 mixedDiffuse, out half4 defaultSmoothness, inout half3 mixedNormal)
{
    half4 diffAlbedo[4];
