    ...
    public class DiggerSystemEditor : Editor
    {
        ...
        private static void SetupURPTerrainMaterial(DiggerSystem diggerSystem, bool forceRefresh)
        {
            ...
            if (!terrainAlreadyHasDiggerMaterial) {
                EditorUtility.DisplayDialog("URP v10, v11, or more recent",
                                            "If you use URP v10 or more recent (v11, etc.) you must import the latest version of Digger URP shaders in Assets/Digger/Shaders folder. " +
                                            "Just double-click on DiggerURP_10_11.unitypackage file.",
                                            "Ok");
            }
        }
