...
public enum StatName {
  [StringValue(nameof(Health))] Health,

  [StringValue(nameof(Level))] Level,

  [StringValue(nameof(Mana))] Mana,

  [StringValue(nameof(Stamia))] Stamia,

  [StringValue(nameof(Experience))] Experience,
  ...
  [StringValue(nameof(Scores))] Scores,

  [StringValue(nameof(Score))] Score,

  [StringValue(nameof(Coin))] Coin,

  [StringValue(nameof(Lives))] Lives,
