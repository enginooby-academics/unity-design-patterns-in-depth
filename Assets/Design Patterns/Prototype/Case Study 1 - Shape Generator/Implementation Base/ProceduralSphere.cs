...
namespace Prototype.Base {
  public class ProceduralSphere : Prototype.ProceduralSphere, ICloneable {
    public ProceduralSphere(string name, Color color, Vector3 position, float radius = 1, int horizontalSegments = 16,
      int verticalSegments = 16) : base(name, color, position, radius, horizontalSegments, verticalSegments) {
    }
