...
namespace Prototype.Naive {
  public class ShapeGenerator : Prototype.ShapeGenerator {
    public override void GenerateShapes() {
      ...
      var cube2 = new ProceduralCube("Cube", Color.red, v0, 1f);
      var cube3 = new ProceduralCube("Cube", Color.yellow, v0, 1f);
      var sphere1 = new ProceduralSphere("Sphere", Color.green, v0, 1f, 16, 16);
      var sphere2 = new ProceduralSphere("Sphere", Color.red, v0, 1f, 16, 16);
      var sphere3 = new ProceduralSphere("Sphere", Color.yellow, v0, 1f, 16, 16);
      var cylinder1 = new ProceduralCylinder("Cylinder", Color.green, v0, 1f, 16, 1);
      var cylinder2 = new ProceduralCylinder("Cylinder", Color.red, v0, 1f, 16, 1);
      var cylinder3 = new ProceduralCylinder("Cylinder", Color.yellow, v0, 1f, 16, 1);
      template = cube1;
    }
    ...
    public override void CloneTemplate() {
      ...
      if (template is ProceduralCube) {
        ...
        var clone = new ProceduralSphere(templateSphere.Name, templateSphere.Color, _mousePos, templateSphere.Radius,
          templateSphere.HorizontalSegments, templateSphere.VerticalSegments);
      }
      else if (template is ProceduralCylinder) {
        var templateCylinder = template as ProceduralCylinder;
        var clone = new ProceduralCylinder(templateCylinder.Name, templateCylinder.Color, _mousePos,
          templateCylinder.Radius, templateCylinder.Segments, templateCylinder.Height);
      }
    }
  }
}