  ...
  public static class Serialization {
    ...
    public static T[] GetValues<T>(this SerializedProperty property) {
      try {
        ...
        for (var i = 0; i < values.Length; i++) values[i] = (T) GetValue(property, targetObjects[i]);
      ...
      switch (property.propertyType) {
        ...
        default:
          ...
          if (accessor != null) {
            ...
            for (var i = 0; i < targets.Length; i++) accessor.SetValue(targets[i], value);
          }
    ...
    /// </summary>
    public static void AddFunction(this GenericMenu menu, string label, MenuFunctionState state,
    ...
    public static void AddPropertyModifierFunction(this GenericMenu menu, SerializedProperty property, string label,
      ...
      => AddPropertyModifierFunction(menu, property, label,
        enabled ? MenuFunctionState.Normal : MenuFunctionState.Disabled, function);
    ...
    /// </summary>
    public static void ModifyValues<T>(this SerializedProperty property, Action<T> method,
      string undoName = "Inspector") {
    ...
    public static void OnPropertyChanged(this SerializedProperty property) {
      ...
      for (var i = 0; i < targets.Length; i++) EditorUtility.SetDirty(targets[i]);
    ...
    public static FieldInfo GetField(PropertyAccessor accessor, SerializedProperty property, Type declaringType,
      string name) {
