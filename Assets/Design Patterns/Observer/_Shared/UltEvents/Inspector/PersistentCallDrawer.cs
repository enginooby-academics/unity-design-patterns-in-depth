  ...
  internal sealed class PersistentCallDrawer : PropertyDrawer {
      ...
      label = EditorGUI.BeginProperty(propertyarea, label, callProperty);
      {
        ...
        if (method != null) {
          ...
          if (DrawerState.Current.callParameters.Length == DrawerState.Current.PersistentArgumentsProperty.arraySize) {
            ...
            for (var i = 0; i < DrawerState.Current.callParameters.Length; i++) {
            ...
            Debug.LogError("Method parameter count doesn't match serialized argument count " +
                           DrawerState.Current.callParameters.Length
    ...
    private static void DoMethodFieldGUI(Rect area, MethodBase method, bool autoOpenMethodMenu) {
      EditorGUI.BeginProperty(area, null, DrawerState.Current.MethodNameProperty);
      {
        ...
        PopupLabelStyle.fontStyle =
          DrawerState.Current.MethodNameProperty.prefabOverride ? FontStyle.Bold : FontStyle.Normal;
    ...
    private static void DoTargetFieldGUI(Rect area, SerializedProperty targetProperty,
      ...
      if (targetProperty.objectReferenceValue == null && !targetProperty.hasMultipleDifferentValues) {
        ...
        if (EditorGUI.EndChangeCheck()) methodNameProperty.stringValue = typeName + "." + methodName;
    ...
    private static void DoTargetObjectFieldGUI(Rect area, SerializedProperty targetProperty,
      ...
      if (EditorGUI.EndChangeCheck()) SetBestTarget(oldTarget, target, out autoOpenMethodMenu);
    ...
    private static void HandleTargetFieldDragAndDrop(Rect area, ref bool autoOpenMethodMenu) {
      ...
      switch (Event.current.type) {
        ...
        case EventType.DragUpdated: {
          ...
          if (dragging != null && dragging.Length == 1) DragAndDrop.visualMode = DragAndDropVisualMode.Copy;
        }
          break;
    ...
    private static void SetBestTarget(Object oldTarget, Object newTarget, out bool autoOpenMethodMenu) {
      ...
      autoOpenMethodMenu =
        BoolPref.AutoOpenMenu && newTarget != null && DrawerState.Current.call.GetMethodSafe() == null;
    }
