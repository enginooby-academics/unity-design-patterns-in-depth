...
namespace UltEvents {
    ...
    public static Type GetReturnType(this MethodBase method) =>
      method.IsConstructor ? method.DeclaringType : (method as MethodInfo).ReturnType;

    /************************************************************************************************************************/

    /// <summary>Returns "AssemblyQualifiedName.MethodName".</summary>
    public static string GetFullyQualifiedName(MethodBase method) =>
      method.DeclaringType.AssemblyQualifiedName + "." + method.Name;
    ...
    public static string DeepToString(this IEnumerable collection) => collection.DeepToString(Environment.NewLine);
    ...
    public static string DeepToString(this IEnumerator enumerator) => enumerator.DeepToString(Environment.NewLine);
